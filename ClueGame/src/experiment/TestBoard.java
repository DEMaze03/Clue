...
public class TestBoard {
	...
	// calcTargets - Calculates the available target spaces given the starting cell
	// and the dice roll (or path length)
	public void calcTargets(TestBoardCell startCell, int pathlength) {
		visitedList.add(startCell);
		findAllTargets(startCell, pathlength);
	}

	// Recursive call to calculate all targets and add to list.
